...
class UserDAO {
    ...
    /**
     * Returns an array of user objects from the database based on all users.
     ...
     * @returns A Promise that resolves true if the user has been succesfully deleted
     */
    deleteUser(username: string): Promise<Boolean> {
     ...
     /**
     * Delete all users objects from the database.
     * @returns A Promise that resolves true if the user has been succesfully deleted
     */
    deleteAll(){
    ...
    /**
     * Update a user object from the database based on the username.
     * @param username The username of the user to update
     * @param name The new name of the user
     * @param surname The new surname of the user
     * @param address The new address of the user
     * @param birthdate The new birthdate of the user
     * @returns A Promise that resolves to the updated user if the user has been succesfully updated
     */
    updateUserInfo(name: string, surname: string, address: string, birthdate: string, username: string): Promise<User>{
      return new Promise<User>((resolve, reject) =>{
        ...
        db.run(sqlUpdate, [name, surname, address, birthdate, username], (err: Error | null) => {
            ...
            db.get(sqlGet, [username], (err: Error | null, row: any) => {
                if (err) {
                    reject(err)
                    return;
                }   
