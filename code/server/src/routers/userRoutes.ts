...
import { BirthdateError, UnauthorizedUserError, UserIsAdminError } from "../errors/userError"
...
class UserRoutes {
    ...
    initRoutes() {
        ...
        this.router.get(
            ...
            .then((users: any /**Users[] */) => res.status(200).json(users))
            .catch((err) => next(err))
        )
