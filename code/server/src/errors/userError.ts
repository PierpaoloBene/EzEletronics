...
const BIRTHDATE_ERROR = "The birthdate cannot be in the future"
...
class BirthdateError extends Error {
    ...
    constructor() {
        super()
        this.customMessage = "The birthdate cannot be in the future"
        this.customCode = 400
    }
}

export { UserNotFoundError, UserNotManagerError, UserNotCustomerError, UserAlreadyExistsError, UserNotAdminError, UserIsAdminError, UnauthorizedUserError, BirthdateError}