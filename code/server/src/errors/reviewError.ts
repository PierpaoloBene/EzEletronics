...
const NO_PRODUCT = "This model does not represent an existing product in the database"
...
class NoExistProductError extends Error {
    customMessage: string
    customCode: number
...
export { ExistingReviewError, NoReviewProductError, NoExistProductError }